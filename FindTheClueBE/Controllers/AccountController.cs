...
namespace FindTheClueBE.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        [AllowAnonymous]
        [Route("FacebookLogin")]
        public async Task<IHttpActionResult> FacebookLogin(FacebookViewModel model)
        {
            ...
            user = await UserManager.FindByNameAsync(fbUser.name);
            ...
            if (user == null)
            {
                ...
                //var loginInfo = new UserLoginInfo("Facebook", model.Token);

                //result = UserManager.AddLogin(newUser.Id, loginInfo);
                //if (!result.Succeeded)
                //{
                //    return GetErrorResult(result);
                //}
        ...
        private async Task<FacebookUserViewModel> VerifyFacebookAccessToken(string accessToken)
        {
            ...
            var path = "https://graph.facebook.com/me?fields=id,email,first_name,last_name,name&access_token=" + accessToken;
